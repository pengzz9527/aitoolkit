...
**Firecrawl** 是一款开源的 Web 数据提取 API，能够将任何网站转化为 AI 可直接使用的干净 Markdown 或结构化 JSON 数据。该项目目前拥有 **146,572 ⭐**，是 GitHub 上最受欢迎的 AI 数据基础设施项目之一。最新版本为 **v2.11.0**（2026 年 6 月发布），提供了搜索、爬取、页面交互、Agent 自动化等多种能力。如果你需要查看或调试 Firecrawl 返回的 JSON 数据，本站的 [JSON 格式化工具](/tools/json-formatter/) 可以帮你快速解析和格式化。
